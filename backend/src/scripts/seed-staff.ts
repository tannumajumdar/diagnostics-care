...
const STAFF = [
  ...
  { name: 'Neha Sharma', email: 'reception.morning@lms.com', password: 'User@123456', role: 'Receptionist', mobile: '9876543215' },
  { name: 'Rohit Verma', email: 'reception.evening@lms.com', password: 'User@123456', role: 'Receptionist', mobile: '9876543216' },
];
