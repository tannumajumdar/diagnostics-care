...
import { ITestPackageDocument } from '../types/package.interface';
 ...
 */
const packageSchema = new Schema<ITestPackageDocument>(
  {
    packageName: {
      type: String,
...
export const TestPackage = model<ITestPackageDocument>('TestPackage', packageSchema);
