...
exports.CHECKUP_PACKAGE = exports.CHECKUP_LIST_TOTAL = exports.CHECKUP_PANELS = void 0;
/**
 ...
 */
const num = (parameterName, shortName, unit, male, female = male, method = '', extra = {}) => ({
    parameterName,
    shortName,
    unit,
...
const strip = (parameterName, shortName, method = 'Reagent strip') => ({
    parameterName,
    shortName,
    unit: '',
...
exports.CHECKUP_LIST_TOTAL = exports.CHECKUP_PANELS.reduce((sum, panel) => sum + panel.rate, 0);
/**
 ...
 */
exports.CHECKUP_PACKAGE = {
    packageName: 'Full Body Checkup (Comprehensive)',
    packageCode: 'FBC-FULL',
    description: 'Comprehensive annual health check - haematology, diabetes, kidney, liver, lipid, thyroid, iron, ' +
