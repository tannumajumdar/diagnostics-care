...
exports.calculateParameterFlag = exports.calculateResultFlag = void 0;
const toNumber = (value) => parseFloat(String(value ?? ''));
/**
 ...
 */
const calculateResultFlag = (valueStr, referenceRange, limits = {}) => {
...
exports.calculateResultFlag = calculateResultFlag;
exports.calculateParameterFlag = exports.calculateResultFlag;
