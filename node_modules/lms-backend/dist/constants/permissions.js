...
exports.MAX_STAFF_DISCOUNT_PERCENT = exports.SELF_APPROVE_PAYOUT_LIMIT = exports.can = exports.permissionsForRole = exports.ROLE_PERMISSIONS = exports.PERMISSIONS = void 0;
...
const ADMIN_PERMISSIONS = Object.values(P);
exports.ROLE_PERMISSIONS = {
    [roles_1.ROLES.ADMIN]: ADMIN_PERMISSIONS,
    [roles_1.ROLES.RECEPTIONIST]: RECEPTIONIST_PERMISSIONS,
    [roles_1.ROLES.PHLEBOTOMIST]: [
        P.PATIENT_VIEW,
        P.APPOINTMENT_VIEW,
        P.APPOINTMENT_MANAGE,
        P.SAMPLE_VIEW,
...
const permissionsForRole = (role) => (role && exports.ROLE_PERMISSIONS[role]) || [];
exports.permissionsForRole = permissionsForRole;
const can = (role, permission) => (0, exports.permissionsForRole)(role).includes(permission);
exports.can = can;
/**
 ...
 */
exports.SELF_APPROVE_PAYOUT_LIMIT = Number(process.env.PAYOUT_SELF_APPROVE_LIMIT || 5000);
/** Discount a non-admin may apply on a bill without approval, in percent. */
exports.MAX_STAFF_DISCOUNT_PERCENT = Number(process.env.MAX_STAFF_DISCOUNT_PERCENT || 20);
