...
async function seedDatabase() {
    try {
        ...
        await Promise.all([
            ...
            expense_model_1.Payout.deleteMany({}),
            ...
            counter_model_1.Counter.deleteMany({}),
        ]);
        ...
        const depts = await department_model_1.Department.create([
        ...
        const doctorPanel = await doctor_model_1.Doctor.create([
            {
        ...
        const doctor = doctorPanel[0];
        const tests = await test_model_1.LabTest.create([
            {
        ...
        await test_model_1.LabTest.create(routineMenu.map((t) => ({
            testName: t.testName,
            testCode: t.testCode,
            ...
            status: 'Active',
            parameters: (0, test_parameters_1.parametersForTest)(t.testName, t.testCode),
        })));
        ...
        await sample_model_1.Sample.create([
            {
        ...
        await expense_model_1.Payout.create([
            {
        ...
        await counter_model_1.Counter.insertMany([
            { name: 'uhid', seq: 1 },
            { name: 'invoice', seq: 1 },
            { name: 'receipt', seq: 1 },
            { name: 'sample', seq: 1 },
