...
function _createForOfIteratorHelper(r, e) { let t = typeof Symbol != "undefined" && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && typeof r.length == "number") { t && (r = t); let _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } let o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { const r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || t.return == null || t.return(); } finally { if (u) { throw o; } } } }; }
...
function getRawData(file) {
  if (file._data && file._data.getContent && file._data.storage) {
...
const out = {
  ...
  generate: function generate(options) {
    ...
    let _iterator = _createForOfIteratorHelper(fileNames),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        const _name = _step.value;
        if (!this.files.hasOwnProperty(_name)) {
          continue;
        }
        const file = this.files[_name];
        const compressionName = file.options.compression || options.compression.toUpperCase();
        ...
        const compressedObject = generateCompressedObjectFrom.call(this, file, compression, compressionOptions);
        const zipPart = generateZipParts.call(this, _name, file, compressedObject, localDirLength, options.platform, options.encodeFileName);
...
function fileAdd(name, data, o) {
  ...
  if (o.dir || data === null || typeof data === "undefined") {
    ...
    o.base64 = false;
    o.binary = true;
    if (!dataType && !(data instanceof CompressedObject) && !(data && data.getContent && data.storage)) {
  ...
  if (this._storage && this._storage.shouldStore(name) && data !== null && !(data instanceof CompressedObject)) {
    let storageEncoding = "utf-8";
    ...
    o.base64 = false;
    o.binary = true;
    data = this._storage.write(data, typeof data === "string" ? storageEncoding : null);
  }
