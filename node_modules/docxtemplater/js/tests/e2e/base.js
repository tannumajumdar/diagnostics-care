...
var _require3 = require("../utils.js"),
  ...
  runWithoutProxy = _require3.runWithoutProxy,
...
describe("Api versioning", function () {
  ...
  it("should fail with invalid versions", function () {
    ...
    expectToThrowSnapshot(function () {
      return doc.verifyApiVersion("3.49.0");
    });
    expectToThrowSnapshot(function () {
      return doc.verifyApiVersion("3.48.100");
    });
  });
});
...
describe("Changing the parser", function () {
  ...
  it("should be able to access meta and context to get the type of tag", function () {
    ...
    var values = [];
    for (var _i6 = 0; _i6 < contexts.length; _i6++) {
      var context = contexts[_i6];
      var _context$meta$part = context.meta.part,
        type = _context$meta$part.type,
        value = _context$meta$part.value,
        module = _context$meta$part.module;
      values.push({
        type: type,
        value: value,
        module: module
    ...
    expect(pX.map(function (_ref3) {
      var _ref3$tag = _ref3.tag,
        type = _ref3$tag.type,
        value = _ref3$tag.value,
        module = _ref3$tag.module;
      return {
        type: type,
        value: value,
        module: module
