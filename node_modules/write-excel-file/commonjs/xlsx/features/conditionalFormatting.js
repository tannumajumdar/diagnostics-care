...
var _sanitizeTextContent = _interopRequireDefault(require("../../xml/sanitizeTextContent.js"));
var _insertElementMarkupAccordingToOrderOfSiblings = _interopRequireDefault(require("../../xml/insertElementMarkupAccordingToOrderOfSiblings.js"));
var _hasFill = _interopRequireDefault(require("../helpers/hasFill.js"));
var _getFillXml = _interopRequireDefault(require("../helpers/getFillXml.js"));
var _hasBorder = _interopRequireDefault(require("../helpers/hasBorder.js"));
var _getBorderXml = _interopRequireDefault(require("../helpers/getBorderXml.js"));
var _hasFont = _interopRequireDefault(require("../helpers/hasFont.js"));
var _getFontXml = _interopRequireDefault(require("../helpers/getFontXml.js"));
var _getCellAddress = _interopRequireDefault(require("../helpers/getCellAddress.js"));
var _getOrderOfSiblings = _interopRequireDefault(require("../helpers/getOrderOfSiblings.js"));
      ...
      'xl/worksheets/sheet{id}.xml': {
        ...
        transform: function transform(xml, sheetOptions, _ref) {
          ...
          if (conditionalFormatting) {
            ...
            return (0, _insertElementMarkupAccordingToOrderOfSiblings["default"])(xml, conditionalFormattingRulesXml, (0, _getOrderOfSiblings["default"])('xl/worksheets/sheet{id}.xml', 'worksheet'), 'worksheet');
          }
          return xml;
        }
      },
...
function getConditionalFormattingRulesXml(conditionalFormattingRules) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(conditionalFormattingRules), _step; !(_step = _iterator()).done;) {
    ...
    var cellRange = (0, _getCellAddress["default"])(from.row - 1, from.column - 1) + ':' + (0, _getCellAddress["default"])(to.row - 1, to.column - 1);
    ...
    if (formula) {
      ...
      xml += "<formula>".concat((0, _sanitizeTextContent["default"])(formula), "</formula>");
      xml += '</cfRule>';
    } else if (operator) {
      xml += "<cfRule type=\"cellIs\" operator=\"".concat(getXlsxOperatorName(operator), "\" dxfId=\"").concat(dxfId, "\" priority=\"").concat(priority, "\">");
      xml += "<formula>".concat((0, _sanitizeTextContent["default"])(formatValue(value)), "</formula>");
      if (getXlsxOperatorName(operator) === 'between') {
        xml += "<formula>".concat((0, _sanitizeTextContent["default"])(formatValue(value2)), "</formula>");
      }
      xml += '</cfRule>';
    } else {
...
function getConditionalFormattingStylesXml(sheetsConditionalFormatting) {
  ...
  for (var _iterator2 = _createForOfIteratorHelperLoose(sheetsConditionalFormatting), _step2; !(_step2 = _iterator2()).done;) {
  ...
  for (var _iterator3 = _createForOfIteratorHelperLoose(sheetsConditionalFormatting), _step3; !(_step3 = _iterator3()).done;) {
    ...
    if (_conditionalFormattingOfSheet) {
      for (var _iterator4 = _createForOfIteratorHelperLoose(_conditionalFormattingOfSheet), _step4; !(_step4 = _iterator4()).done;) {
        ...
        if ((0, _hasBorder["default"])(border)) {
