...
exports["default"] = getFontXml;
var _sanitizeAttributeValue = _interopRequireDefault(require("../../xml/sanitizeAttributeValue.js"));
var _getXlsxColorForHexColor = _interopRequireDefault(require("./getXlsxColorForHexColor.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
function getFontXml(font) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    isDefaultGenericFont = _ref.isDefaultGenericFont;
  ...
  if (fontFamily) {
    ...
    xml += "<name val=\"".concat((0, _sanitizeAttributeValue["default"])(fontFamily), "\"/>");
  }
  ...
  // Apply `textColor`
  if (textColor) {
    xml += "<color rgb=\"".concat((0, _sanitizeAttributeValue["default"])((0, _getXlsxColorForHexColor["default"])(textColor)), "\"/>");
  } else {
...
//# sourceMappingURL=getFontXml.js.map