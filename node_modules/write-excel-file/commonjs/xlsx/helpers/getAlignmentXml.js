...
exports["default"] = getAlignmentXml;
...
function getAlignmentXml(_ref) {
  var align = _ref.align,
    ...
    indent = _ref.indent,
    wrap = _ref.wrap;
  return '<alignment' + (align ? " horizontal=\"".concat((0, _sanitizeAttributeValue["default"])(align), "\"") : '') + (alignVertical ? " vertical=\"".concat((0, _sanitizeAttributeValue["default"])(alignVertical), "\"") : '') + (textRotation ? " textRotation=\"".concat(getTextRotation(validateTextRotation(textRotation)), "\"") : '') + (indent ? " indent=\"".concat((0, _sanitizeAttributeValue["default"])(String(indent)), "\"") : '') + (wrap ? " wrapText=\"1\"" : '') + '/>';
}
...
//# sourceMappingURL=getAlignmentXml.js.map