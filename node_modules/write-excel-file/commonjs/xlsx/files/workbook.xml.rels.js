...
exports["default"] = generateWorkbookXmlRels;
...
function generateWorkbookXmlRels(_ref) {
  ...
  (0, _getAdditionalContent["default"])('xl/_rels/workbook.xml.rels', features, sheetsOptions) + '</Relationships>';

  // Apply any plugins that transform this XML.
  xml = (0, _transformContent["default"])(xml, 'xl/_rels/workbook.xml.rels', features, sheetsOptions);
  return xml;
}
