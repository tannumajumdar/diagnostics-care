...
exports["default"] = insertElementMarkupAccordingToOrderOfSiblings;
var _findElement = _interopRequireDefault(require("./findElement.js"));
var _findElementsNonRecursive_ = require("./findElementsNonRecursive_.js");
var _appendMarkupInsideElement = _interopRequireDefault(require("./appendMarkupInsideElement.js"));
var _getChildElements = _interopRequireDefault(require("./getChildElements.js"));
var _prependMarkupInsideElement = _interopRequireDefault(require("./prependMarkupInsideElement.js"));
...
function insertElementMarkupAccordingToOrderOfSiblings(xml, elementMarkup, orderOfSiblings) {
  ...
  var _loop = function _loop() {
    ...
    if (parentElement) {
      ...
      parentElement = (0, _getChildElements["default"])(xml, parentElement).find(function (_) {
        return _.tagName === parentElementTagName;
      });
    } else {
      parentElement = (0, _findElement["default"])(xml, parentElementTagName);
    }
    if (!parentElement) {
  ...
  if (!orderOfSiblings || orderOfSiblings.length < 2) {
    return (0, _appendMarkupInsideElement["default"])(xml, parentElement, elementMarkup);
  }
  var children = (0, _getChildElements["default"])(xml, parentElement);
  ...
  return (0, _prependMarkupInsideElement["default"])(xml, parentElement, elementMarkup);
}
var TAG_NAME_REG_EXP = new RegExp((0, _findElementsNonRecursive_.getOpeningTagRegExpPattern)());
...
// 	}
// }
//# sourceMappingURL=insertElementMarkupAccordingToOrderOfSiblings.js.map